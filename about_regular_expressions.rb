...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # With an array or hashes
    # assert_equal __, ["aaa", "zzz"][/z*/] => TypeError: no implicit conversion of Regexp into Integer
  end
  ...
  # Character class matches a range of characters, while an alternation matches specific instances within.
  # ------------------------------------------------------------------
